import { createSuccessResponse, createErrorResponse, logInfo, logError, getUserById } from '../utils/common.js';
...
export const updatePrivacySecurity = async (req, res) => {
  try {
    ...
    if (!validationResult.isValid) {
      return res.status(400).json(createErrorResponse(400, 'Validation failed', validationResult.errors));
    }
