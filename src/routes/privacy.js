...
router.get('/security', authMiddleware, getPrivacySecurity);
...
// Account Deletion
router.get('/account/delete', authMiddleware, getAccountDeletionStatus);
...
// Account Retrieval
router.get('/account/retrieve', authMiddleware, getAccountRetrieve);
